        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 min-w-10 min-h-10 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center hover:bg-yellow-300 transition-colors duration-300 shadow-lg hover:shadow-yellow-400/25" aria-label="Facebook">
                {/* Facebook SVG */}
              ...
              <a href="#" className="w-10 h-10 min-w-10 min-h-10 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center hover:bg-yellow-300 transition-colors duration-300 shadow-lg hover:shadow-yellow-400/25" aria-label="Instagram">
                {/* Instagram SVG */}
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="w-10 h-10 min-w-10 min-h-10 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center hover:bg-yellow-300 transition-colors duration-300 shadow-lg hover:shadow-yellow-400/25" aria-label="TikTok">
                {/* TikTok SVG */}
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="w-10 h-10 min-w-10 min-h-10 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center hover:bg-yellow-300 transition-colors duration-300 shadow-lg hover:shadow-yellow-400/25" aria-label="Pinterest">
                {/* Pinterest SVG */}
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li><a href="/" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 flex items-center gap-2 text-base">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"/>
                </svg>
                Home
              </a></li>
              <li><a href="/#about" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 flex items-center gap-2 text-base">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"/>
                </svg>
                About Us
              </a></li>
              <li><a href="/vehicles" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 flex items-center gap-2 text-base">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <li><a href="/#services" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 flex items-center gap-2 text-base">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clipRule="evenodd"/>
                </svg>
                Services
              </a></li>
              <li><a href="/#gallery" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 flex items-center gap-2 text-base">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li className="text-gray-300 flex items-center gap-2 text-base">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-base md:text-sm">
              © 2024 CeylonStep. All rights reserved. | 
            ...
            <div className="flex items-center gap-2 text-gray-400 text-base md:text-sm">
              <span>Made with</span>
