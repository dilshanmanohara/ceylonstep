...
export default function Header() {
  ...
  <header className="!fixed !top-0 !left-0 !w-full !z-[9999] bg-gray-900/95 backdrop-blur-md text-white flex items-center justify-between px-8 py-3 shadow-lg border-b-2 border-yellow-400/50 relative overflow-hidden">
      ...
      <button
        className={`md:hidden flex flex-col gap-1.5 items-center justify-center p-2 rounded hover:bg-yellow-400/10 transition relative z-50 ${drawerOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
      ...
      {drawerOpen && (
        <>
          ...
          />
          <nav className="fixed inset-0 bg-gray-900/95 z-50 flex flex-col p-6 gap-8 animate-slide-in-mobile border-none overflow-y-auto">
            {/* Close (X) button */}
            <button
              className="absolute top-6 right-6 z-50 flex items-center justify-center text-yellow-400 hover:text-yellow-300 text-3xl font-bold focus:outline-none bg-black/10 rounded-full w-12 h-12"
              onClick={() => setDrawerOpen(false)}
            ...
            <div className="flex flex-col items-center gap-4 mt-16 mb-8">
              <img src="/logo.png" alt="CeylonStep Logo" className="h-16 w-16 object-cover rounded-full border-2 border-yellow-400 shadow-lg" />
              <span className="text-2xl font-extrabold tracking-tight text-yellow-400">CeylonStep</span>
            </div>
            <ul className="flex flex-col gap-8 text-2xl font-bold text-gray-100 w-full items-center">
              <li><a href="/" onClick={() => setDrawerOpen(false)} className="hover:text-yellow-400 transition py-2 px-6 rounded-xl w-full text-center">Home</a></li>
              <li><a href="/#about" onClick={() => setDrawerOpen(false)} className="hover:text-yellow-400 transition py-2 px-6 rounded-xl w-full text-center">About</a></li>
              <li><a href="/vehicles" onClick={() => setDrawerOpen(false)} className="hover:text-yellow-400 transition py-2 px-6 rounded-xl w-full text-center">Vehicles</a></li>
              <li><a href="/#services" onClick={() => setDrawerOpen(false)} className="hover:text-yellow-400 transition py-2 px-6 rounded-xl w-full text-center">Services</a></li>
              <li><a href="/#gallery" onClick={() => setDrawerOpen(false)} className="hover:text-yellow-400 transition py-2 px-6 rounded-xl w-full text-center">Gallery</a></li>
              <li><a href="/#reviews" onClick={() => setDrawerOpen(false)} className="hover:text-yellow-400 transition py-2 px-6 rounded-xl w-full text-center">Reviews</a></li>
              <li><a href="/#contact" onClick={() => setDrawerOpen(false)} className="hover:text-yellow-400 transition py-2 px-6 rounded-xl w-full text-center">Contact</a></li>
            </ul>
            <div className="flex justify-center gap-6 mt-12">
              <a href="#" className="w-12 h-12 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center hover:bg-yellow-300 transition-colors duration-300 shadow-lg" aria-label="Facebook">
              ...
              <a href="#" className="w-12 h-12 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center hover:bg-yellow-300 transition-colors duration-300 shadow-lg" aria-label="Instagram">
              ...
              <a href="#" className="w-12 h-12 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center hover:bg-yellow-300 transition-colors duration-300 shadow-lg" aria-label="TikTok">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12.75 2v12.25a2.25 2.25 0 11-2.25-2.25c.124 0 .25.012.375.037V9.75a5.25 5.25 0 102.25 4.5V2h-0.375zm6.75 0v2.25a3.75 3.75 0 01-3.75-3.75H15V9.75a7.5 7.5 0 007.5 7.5v-2.25a5.25 5.25 0 01-5.25-5.25V2h-0.375z"/></svg>
              </a>
            </div>
          </nav>
          <style>{`
            ...
            .animate-slide-in-mobile {
              animation: slide-in-mobile 0.35s cubic-bezier(0.4,0,0.2,1);
            }
          `}</style>
        </>
      )}
